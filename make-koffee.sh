...
VERSION=0.7
DEFCONFIG=lineageos_a6000_defconfig
TOOLCHAIN='toolchain/arm-eabi-gcc/bin/arm-eabi-'
KCONFIG=false
CUST_CONF=no
BUILD_NUMBER=2
DEVICE=a6000
KCONF_REPLACE=false
KERNEL_NAME="LayeardDevMod-Project"
SKIP_MODULES=true
DONTPACK=false
USER=$USER
DATE=`date`
...
usage() {
	...
	echo `date`
	echo "Written by A\$teroid <xvae27@gmail.com>"
	echo ""
    echo "Usage:"
    echo ""
